...
//============================================================================
  ...
  function tagSuffix(p_name) {

    if(typeof $dataMap.meta[p_name] !== 'boolean'){
      return name + Number($dataMap.meta[p_name]);
    }

    return name + $gameMap._mapId;
  }
...
//============================================================================
  ...
  if (!$.groundName) name = name + tagSuffix(name);
...
//============================================================================
    ...
    if ( !$.parallaxName ) name = name + tagSuffix(name);
...
//============================================================================
  ...
  if ( !$.groundName ) groundName = groundName + tagSuffix(groundName);
//============================================================================
...
//============================================================================
    ...
    if ( !$.parallaxName ) parallaxName = parallaxName + tagSuffix(parallaxName);
//============================================================================
