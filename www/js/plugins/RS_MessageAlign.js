...
(function() {
    ...
    Window_Base.prototype.drawTextEx = function(text, x, y) {
        if (text) {
            ...
            // @HACK - Kit9 Studio LTD (2023)
            // Coffin of Andy and Leyley
            
            // Debugging shows this CALL causes the 
            // problem with name text creeping along 
            // when using centering.  Not sure the
            // intention of this, so might have 
            // side effects in other setups.
